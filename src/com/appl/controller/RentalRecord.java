...
public class RentalRecord extends DateTime{
    ...
    {
        if(this.ActualReturnDate==null && this.getRentalFee()==null && this.getLateFee()==null){
            String data = this.RentId+":"+this.RentDate.toString()+":"+this.EstimatedReturnDate.toString()+":none:none:none";
            return data;
        }
        else{
           return this.RentId+":"+this.RentDate.toString()+":"+this.EstimatedReturnDate.toString()+":"+this.ActualReturnDate.toString()+":"+this.getRentalFee().toString()+":"+this.getLateFee().toString();
        }
    }
    ...
    public String getDetails()
    {
        if(this.ActualReturnDate==null && this.getRentalFee()==null && this.getLateFee()==null) {
            ...
            return      "Record ID:             " + this.RentId
                    ...
                    + "\nRental Fee:            "+String.format ("%.2f", this.getRentalFee())+
                      "\nLate Fee:              "+String.format("%.2f", this.getLateFee());
        }
    }
