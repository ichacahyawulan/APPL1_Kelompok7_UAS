...
public class Car extends  Vehicle {
    ...
    public Car(String VehicleId,int Year,String Make,String Model,int RentByCust,int status,VehicleType vehicleType)
    {
    ...
    public  boolean returnVehicle(DateTime returnDate)
    {
        ...
        {
        DateTime estdate= this.getRecords()[this.getLastElementIndex()].getEstimatedReturnDate();
        ...
        if(vehicleType.equals("car") && DateTime.diffDays(returnDate,estdate)<0 && DateTime.diffDays(returnDate,rentDate)<this.vehicleType.canBeRentedForMinimumDays(rentDate,vehicleType)){
            ...
            this.getRecords()[this.getLastElementIndex()].setData(returnDate,this.rentRate * DateTime.diffDays(returnDate,rentDate),this.getLateFee(returnDate,estdate));
